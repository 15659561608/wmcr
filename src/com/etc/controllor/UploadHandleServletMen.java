 ...
 */
@WebServlet("/UploadSm")
public class UploadHandleServletMen extends HttpServlet {

	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 得到上传文件的保存目录，将上传的文件存放于WEB-INF目录下，不允许外界直接访问，保证上传文件的安全
		
		String savePath =this.getServletContext().getRealPath("/uploads"); //this.getServletContext().getRealPath("/WEB-INF/upload");
...
//						message = "文件上传成功！";
						...
						pw.print("<script>alert('请选择店面');location.href='bossManage/picture-add2.jsp'</script>");
					} else {
