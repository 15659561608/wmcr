...
<body>
	...
	<div class="common-head clearfix">
		<a class="logo" href="index.jsp"> <img src="img/logo.png" alt="">
		</a>

		<div class="right pull-right text-right" id="hovpad">
			<dl class="user-wrapper">
				<dt>
					<span class="time">欢迎您</span>${sessionScope.administor.account}<img
						src="img/headjt.png" alt=""><img class="active"
						src="img/headjt-active.png" alt="">
				</dt>
				<dd>
	...
	<div class="side-bar">
		...
		<dl>
				<dt>
					主页 <img class="b" src="img/jt-right-co.png" alt=""><img
						class="r" src="img/jt-bottom.png" alt="">
				</dt>
				<dd>
					<a href="#view/accountAnalyseChart.jsp">统计分析 </a>
			...
			<dl>
				<dt style="border-top: none;">
					用户管理 <img class="b" src="img/jt-right-co.png" alt=""><img
						class="r" src="img/jt-bottom.png" alt="">
				</dt>
				<dd>
			...
			<dl>
				<dt>
					商户管理 <img class="b" src="img/jt-right-co.png" alt=""><img
						class="r" src="img/jt-bottom.png" alt="">
				</dt>
				<dd>
			...
			<dl>
				<dt>
					订单管理 <img class="b" src="img/jt-right-co.png" alt=""><img
						class="r" src="img/jt-bottom.png" alt="">
				</dt>
				<dd>
			...
			<dl>
				<dt>
					评论管理 <img class="b" src="img/jt-right-co.png" alt=""><img
						class="r" src="img/jt-bottom.png" alt="">
				</dt>
				<dd>
			...
			<dl>
				<dt>
					城市管理 <img class="b" src="img/jt-right-co.png" alt=""><img
						class="r" src="img/jt-bottom.png" alt="">
				</dt>
				<dd>
					<a href="#view/city.jsp">城市列表 </a> 
					<a href="#view/addCity.jsp">增加城市</a>
				...
				<dl>
				<dt>
					店铺管理 <img class="b" src="img/jt-right-co.png" alt=""><img
						class="r" src="img/jt-bottom.png" alt="">
				</dt>
				<dd>
				...
				<dl>
				<dt>
					菜品类别 <img class="b" src="img/jt-right-co.png" alt=""><img
						class="r" src="img/jt-bottom.png" alt="">
				</dt>
				<dd>
				...
				<dl>
				<dt>
					关于我们 <img class="b" src="img/jt-right-co.png" alt=""><img
						class="r" src="img/jt-bottom.png" alt="">
				</dt>
				<dd>
					<a href="#city.jsp">老板们 </a> 
	...
	<div id="main">
		<div
			...
			<iframe class="scroll" src="view/accountAnalyseChart.jsp" id="ghrzFrame"
...
<script>
	...
	$('.side-bar dd a[href="#' + $('#main iframe').attr('src') + '"]')
			.addClass('active');
