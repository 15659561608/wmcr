            ...
            <aside class="fl">
                <article class="cart" scroll-position-static="160" top="42">
                    <div class="menu-cart">
                        ...
                        <section>
                       <form action="sds.do" methods="post">
                            <div class="inner-cart empty" ng-class="{empty:isEmpty}">
                                <div class="cart-thead clearfix">
                                    ...
                                    <div class="disnone" ng-class="{disnone:isEmpty}">
                                        <div class="cart-item cart-data clearfix" ng-repeat="obj in cartDatas">
                                         ...
                                         <input type="hidden" name="op" value="addOrdersDetail" />
                                       
                                      <input type="hidden" name="foodId" value="" ng-value="obj.id" />                      
                                      <input type="hidden" name="foodName" value="" ng-value="obj.name" />
                                       <input type="hidden" name="num"  value="" ng-value="obj.quantity" />
                                       <input type="hidden" name="price"  value="" ng-value="obj.price|number:2" />
                                            ...
                                            <div class="goods-price">￥<span ng-bind="obj.price|number:2"></span>
                                             </div>
                                            <div class="goods-subtotal">￥<span ng-bind="(obj.quantity * obj.price)|number:2"></span>
                                ...
                                <div class="checkout">
                                <button type="submit" class="btn checkout" ng-disabled="isPlaceOrder">立即下单11</button> 
