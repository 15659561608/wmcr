...
<%@page import="com.etc.entity.Food"%>
            ...
            <div class="main fl">
                <div class="inner-main">
                    ...
                    <article class="collapse section-39215">
						...
						<jsp:forward page="../fsf.do?op=getFoods"></jsp:forward>
								</c:if>
                                      <c:forEach items="${requestScope.pd.data}" var="food">      
                                    <li title="${food.foodName}" class="menu-item hasImg" accessorykey="${food.id}-2048898" data-sale="${food.salNum}" data-price="${food.price}">
                                        <div class="menu-item-img">  
                                            <img data-src="${food.logo}" src="${food.logo}"  width="202" height="202" /> 
                                        </div>
...
<script type="text/javascript">
	    ...
	    $(function(){
	    	...
	    	$.get("../fsf.do?op=getFoods",function(data){
	    		
	    		//得到的data应该是一个string类型满足 json格式
	    		//var arr = JSON.parse(data);
	    		
	    		/* $.each(data.list,function(i,d){	    			
	    			$("#DNAME").append("<option value="+d.DEPTNO+">"+d.DNAME+"</option>");
	    		}); */
	    		
	    		$.each(data, function(idx, obj) {
	    		   console.log(obj.id+" "+obj.foodName+" "+obj.price+" "+obj.logo);
	    		});
