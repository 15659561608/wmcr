...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath }/wmcr/css/checkout.css"/>
    ...
    <dh-dialog class="disnone" header="使用新地址/修改地址" width="420" show="editUserAddress">
     ...
     <ul class="site-fixed">
        ...
        <li class="scorll-feekback" ng-click="userFeedback=true">
            <img src="${pageContext.request.contextPath }/wmcr/images/scorll_feekback.png" alt=""/>
            <div>意见反馈</div>
        </li>
        <li class="scroll-wx">
