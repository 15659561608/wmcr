...
<body>
	...
	<script>
		...
		employee.requestUrl = {
			queryList : employee.url + "wmcr/SalesServlet?op=queryHis" //数据是从servlet一侧返回的 json格式
		};
		...
		employee.filed = [
				{ //第一个列
					...
					"createdCell" : function(nTd, sData, oData, iRow, iCol) {
						$(nTd)
								.html(
										"<input type='checkbox' value='"+oData.id+"' name='checkList' value='" + sData + "'>");
					}
				...
				{ //创建操作那个列
					...
					"createdCell" : function(nTd, sData, oData, iRow, iCol) {
						...
						$(nTd).html("<button class='layui-btn layui-btn-warm layui-btn-sm'>已删除</button>");
