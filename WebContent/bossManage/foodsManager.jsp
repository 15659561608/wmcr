...
<div class="page-container">
 ...
 <div class="text-c">
			...
			<div class="text-c"> 
			菜名：<input type="text" class="form-controlSearch input-text " placeholder="输入 门店名" data-column="2" id="col2_filter" style="width:100px;">
		  
			</div>
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加门店','addFoodsf.jsp','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a></span> <span class="r">共有数据：<strong><span id="datarowcount"></span></strong> 条</span> </div>
			<div class="mt-20">
				<table id="example" class="table table-border table-bordered table-hover table-bg table-sort">
					<thead>
						<tr class="text-c">
							<th width="5%"><input type="checkbox" id="employeeCheckAll" name="employeeCheckAll"></th>
					...
					<th class="sort cur" style="width: 5%;">价格<img
						class="bottom"
						src="${pageContext.request.contextPath}/back/img/jt-bottom.png"
						alt=""> <img class="top" style="display: none"
						src="${pageContext.request.contextPath}/back/img/jt-right-co.png"
					...
					<th class="sort cur" style="width: 5%;">折扣 <img
						class="bottom"
						src="${pageContext.request.contextPath}/back/img/jt-bottom.png"
						alt=""> <img class="top" style="display: none"
						src="${pageContext.request.contextPath}/back/img/jt-right-co.png"
					...
					<th class="sort cur" style="width: 5%;">剩余数量 <img class="bottom"
						src="${pageContext.request.contextPath}/back/img/jt-bottom.png"
						alt=""> <img class="top" style="display: none"
						src="${pageContext.request.contextPath}/back/img/jt-right-co.png"
						alt="">
					...
					<tbody>	<c:if test="${requestScope.pd == null}">
