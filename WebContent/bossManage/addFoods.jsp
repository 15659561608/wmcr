...
<body>
	<nav class="breadcrumb">
		...
		菜品管理 <span class="c-gray en">&gt;</span> 修改菜品信息<a
	...
	<div class="page-container">
		<form method="POST" enctype="multipart/form-data"
			action="${pageContext.request.contextPath}/fsf.do?op=addFoods"
			class="form form-horizontal responsive" id="demoform"
			novalidate="novalidate">
			<div class="row cl">
				<label class="form-label col-xs-3">菜名：</label>
				<div class="formControls col-xs-8">
				
					 <input type="hidden"  id="logo-value" name="logo" />  <input
						type="hidden" class="form-control" id="busid" name="busid"
						value="${sessionScope.boss.id}" /> <input type="text"
						class="input-text" placeholder="请输入美食名" name="foodName"
						id="foodName" autocomplete="off">
				</div>
			</div>
			<div class="row cl">
