...
<body>
	<div class="page-container">
		<form action="../Business?op=add" method="post" class="form form-horizontal responsive"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8">
					<input type="text" class="input-text" placeholder="输入门店名"
						name="busiName" id="busiName" autocomplete="off">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-3">电话：</label>
				<div class="formControls col-xs-8">
					<input type="text" class="input-text" placeholder="输入电话"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8">
					<input type="text" class="input-text" placeholder="输入地址"
